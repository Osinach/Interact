...
namespace InteractIntranet.InteractHelper
{
    public class BaseClass
    {
        ...
        public static InteractHomePage GivenINavigateToInteractHomePage()
        {
            LaunchUrl("https://www.interact-intranet.com//");
            return new InteractHomePage();
        }
